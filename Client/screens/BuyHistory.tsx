            ...
            <View style={styles.container}>
                ...
                {this.state.data ?
                    <><Datatable
                        ...
                        />
                        <Button color="red" title={"istorijos ištrynimas"} onPress={this.AlertDestroy} />
