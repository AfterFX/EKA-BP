...
import {countTotal, payTotal} from "./functions";


const array = [
    [  "Alfreds Futterkiste", "1", "Germany"  ],
    [  "Alfreds Futterkiste", "2", "Germany"  ],
    [  "Alfreds Futterkiste", "3", "Germany"  ],
    [  "Alfreds Futterkiste", "4", "Germany"  ],
    [  "Alfreds Futterkiste", "5", "Germany"  ],
    [  "Alfreds Futterkiste", "6", "Germany"  ],

]

const createDynamicTable = (number) => {
    var table = '';
    for (let i in array) {
        const item = array[i];
        table = table + `
