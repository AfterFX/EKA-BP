...
export const createDynamicTable = (number: any, storedPrices: any) => {
    ...
    <table align="left" cellspacing="0" border="0">
        ...
        <tr>
            ...
            <td style="${priceBox}" align="center" valign=middle bgcolor="#FFFFFF">${storedPrices['r_a1']}</td>
        ...
        <tr>
            ...
            <td style="${priceBox} border-bottom: 1px solid #000000;" align="center" valign=middle bgcolor="#FFFFFF">${storedPrices['s_remontas']}</td>
            ...
            <td style="${priceBox} border-bottom: 1px solid #000000;" align="center" valign=middle>${storedPrices['r_remontas']}</td>
